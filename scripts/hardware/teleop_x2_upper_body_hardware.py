...
from xrobotoolkit_teleop.hardware.x2_ros2_teleop_controller import (
    ...
    DEFAULT_X2_CAMERA_VIDEO_HEIGHT,
    DEFAULT_X2_CAMERA_VIDEO_STREAMS,
    DEFAULT_X2_CAMERA_VIDEO_WIDTH,
...
def main(
    ...
    controller = X2Ros2TeleopController(
        ...
        camera_video_streams=camera_video_streams,
        camera_width=camera_width,
        camera_height=camera_height,
        camera_video_width=camera_video_width,
        camera_video_height=camera_video_height,
